...
func (c *Controller) HandleShows(w http.ResponseWriter, r *http.Request) {
...
func (c *Controller) HandleShow() http.HandlerFunc {
	v := view.View{
		MainTmpl: "show.tmpl",
	...
	return func(w http.ResponseWriter, r *http.Request) {
		sm := models.NewShowModel(c.Session)
...
func (c *Controller) HandleTimeslot() http.HandlerFunc {
	v := view.View{
		MainTmpl: "timeslot.tmpl",
		Context:  c.Config.PageContext,
	}
...
func (c *Controller) HandleSeason(w http.ResponseWriter, r *http.Request) {
	sm := models.NewShowModel(c.Session)
...
func (c *Controller) HandlePodcastRssHead(w http.ResponseWriter, r *http.Request) {
	sm := models.NewShowModel(c.Session)
...
func (c *Controller) HandlePodcastRss(w http.ResponseWriter, r *http.Request) {
	sm := models.NewShowModel(c.Session)
...
func (c *Controller) HandleUYCO() http.HandlerFunc {
	v := view.View{
		MainTmpl: "uyco.tmpl",
		Context:  c.Config.PageContext,
	}
